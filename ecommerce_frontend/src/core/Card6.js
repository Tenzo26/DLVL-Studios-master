...
const Card6 = ({
	...
	const showStock = (qSmall, qMed, qLarge, qFree) => {
		return qSmall > 0 || qMed  > 0 || qLarge > 0 || qFree > 0 ? (
			<span>
				<span className="badge badge-primary badge-pill pillCard6" style = {{display: qSmall > 0 ? '' : "none"}}>S</span>
				<span className="badge badge-primary badge-pill pillCard6" style = {{display: qMed > 0 ? '' : "none"}}>M</span>
				<span className="badge badge-primary badge-pill pillCard6" style = {{display: qLarge > 0 ? '' : "none"}}>L</span>
				<span className="badge badge-primary badge-pill pillCard6" style = {{display: qFree > 0 ? '' : "none"}}>FS</span>
			</span>
			
		) : (
			<span className="badge badge-danger badge-pill pillCard6">Out of Stock </span>
		);
	};
	...
	return (
		<div className="card6">
			<div className="card-body3">
				...
				<div className="card-header3 card-header-1 "><h1 className="cardHead6">{product.name}</h1></div>
				{/* <p className="card-p_card4">
					{product.description.substring(0, 100)}{" "}
				</p> */}
				<p className="card-p_card4 price card6color">&#8369; {product.price.toLocaleString()}.00</p>
				{/* <p className="black-9">
                ...
                <p className="card-p_card4 card6color">
