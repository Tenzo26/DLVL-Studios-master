...
import ShowImage_1 from "./ShowImage_1_Mob";
...
const Card3 = ({
	...
	const showStock = (qSmall, qMed, qLarge, qFree) => {
		return qSmall > 0 || qMed  > 0 || qLarge > 0 || qFree > 0 ? (
			<span>
				<span className="badge badge-primary badge-pill pillCard3" style = {{display: qSmall > 0 ? '' : "none"}}>S </span>
				<span className="badge badge-primary badge-pill pillCard3" style = {{display: qMed > 0 ? '' : "none"}}>M </span>
				<span className="badge badge-primary badge-pill pillCard3" style = {{display: qLarge > 0 ? '' : "none"}}>L </span>
				<span className="badge badge-primary badge-pill pillCard3" style = {{display: qFree > 0 ? '' : "none"}}>FS </span>
			</span>
			
		) : (
			<span className="badge badge-danger badge-pill pillCard3">Out of Stock </span>
		);
	};
	...
	return (
		<div className="cardcoll2">
			<div className="card-body2">
                ...
                <div className="card-header2 card-header-1 "><h1 style={{textAlign:"center"}} className="h1CollHead">{product.name}</h1></div>
				{/* <p className="card-p  mt-2">
					{product.description.substring(0, 100)}{" "}
				</p> */}
				{/*<p className="card-p_card3 price">&#8369; {product.price}</p>
				<p className="cardb_card3">
